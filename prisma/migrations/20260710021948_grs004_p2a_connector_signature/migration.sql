...
INSERT INTO "new_CAConnection" ("caProjectId", "caType", "connectorBaseUrl", "connectorId", "connectorSecret", "connectorVersion", "createdAt", "disabledAt", "handshakeCompletedAt", "id", "ingestionSource", "ingestionStatus", "lastSyncedAt", "raceProjectId", "registeredAt", "updatedAt") SELECT "caProjectId", "caType", "connectorBaseUrl", "connectorId", "connectorSecret", "connectorVersion", "createdAt", "disabledAt", "handshakeCompletedAt", "id", "ingestionSource", "ingestionStatus", "lastSyncedAt", "raceProjectId", "registeredAt", "updatedAt" FROM "CAConnection";
