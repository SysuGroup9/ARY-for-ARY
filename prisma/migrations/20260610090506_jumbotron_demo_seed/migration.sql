/*
  ...
  - You are about to drop the column `trackId` on the `Race` table. All the data in the column will be lost.
...
CREATE TABLE "new_Race" (
    ...
    "trackCenterlineJson" TEXT,
    "checkpointCount" INTEGER NOT NULL DEFAULT 3,
