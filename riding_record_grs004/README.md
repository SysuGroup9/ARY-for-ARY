# GRS003 Riding Record

这个目录用于存放 GRS003 相关的个人 Riding Record、分工记录与过程材料。

## Contents

- [xiaoyi](./xiaoyi.md) — 肖懿的 GRS003 技术实现、Demo 落地与测试验证记录。
...
- 本目录只收录 GRS003 相关记录；个人 riding record 应尽量说明个人角色、关键贡献、重要对话节点、仍需关注的缺口和简短结论。
