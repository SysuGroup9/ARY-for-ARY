# GRS004 Riding Record

这个目录用于存放 GRS004 相关的个人 Riding Record、分工记录与过程材料。
...
- [黄智亮's riding_record](./黄智亮's%20riding_record.md) — 黄智亮的 GRS004 团队功能实现、测试审查与项目细节补充记录。
- [小组分工](./小组分工.md) — GRS004 阶段团队角色、职责分工和关键协作节点。
...
- 本目录只收录 GRS004 相关记录；个人 riding record 应尽量说明个人角色、关键贡献、重要对话节点、仍需关注的缺口和简短结论。
- 新增成员记录时，请同步更新本 README 的 Contents 与 Directory structure。
