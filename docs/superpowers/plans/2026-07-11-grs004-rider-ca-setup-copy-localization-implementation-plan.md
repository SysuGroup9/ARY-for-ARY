...
✅ 从 `docs/grs004` 核对 Rider View / CA Ingestion Status 的目标口径
✅ 扫描 `rider-console-page.tsx` 中 `ca-setup` 的英文残留
✅ 补设计文档
✅ 为 Rider 视图眉标补中文化收口
✅ 为报名状态和聚合接入状态补状态值映射
✅ 为 CA 接入表单与 CA 连接卡补中文标签
✅ 为握手、禁用、轮换提示补中文映射
✅ 更新 `src/app/_components/console/rider-console-page.test.tsx`
✅ 回归 `src/app/_components/console/review-readiness-card.test.tsx`
✅ 跑 `npm run build`
