...
test("home hero renders readable Chinese labels instead of mojibake text", () => {
...
test("home gallery renders readable Chinese public copy instead of mojibake text", () => {
