...
test("generateRaceSnapshotAction follows managed-race organizer and system admin boundaries", () => {
  ...
  assert.match(functionSource, /await generateRaceSnapshot\(raceId\)/);
});
