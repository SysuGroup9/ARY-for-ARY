...
const raceEditSystemActions = [
  {
    name: "updateRaceAction",
    next: "updateOrganizerCommentAction",
    serviceCall: "updateRaceContent",
  },
  {
    name: "updateOrganizerCommentAction",
    next: "updateTeamCommentAction",
    serviceCall: "updateOrganizerComment",
  },
  {
    name: "updateDisplayOptionsAction",
    next: "generateRaceSnapshotAction",
    serviceCall: "updateRaceDisplayOptions",
  },
] as const;
...
test("race edit actions allow admin/system callers instead of organizer-only gates", () => {
  for (const action of raceEditSystemActions) {
